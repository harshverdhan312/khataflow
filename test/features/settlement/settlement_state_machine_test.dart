...
void main() {
  group('SettlementStatus State Machine', () {
    test('converts each enum value to correct DB string value', () {
      ...
      expect(SettlementStatus.upiLaunched.toDbValue(), equals('UPI_LAUNCHED'));
    ...
    test('parses DB string values correctly', () {
      expect(SettlementStatus.fromDbValue('INITIATED'), equals(SettlementStatus.initiated));
      expect(SettlementStatus.fromDbValue('UPI_LAUNCHED'), equals(SettlementStatus.upiLaunched));
    ...
    test('correctly identifies terminal states', () {
      ...
      expect(SettlementStatus.upiLaunched.isTerminal, isFalse);
    ...
    test('correctly identifies unresolved states', () {
      ...
      expect(SettlementStatus.upiLaunched.isUnresolved, isTrue);
    ...
    test('correctly identifies settled status', () {
      ...
      expect(SettlementStatus.upiLaunched.isSettled, isFalse);
